...
**2.** ***Artificial intelligence, algorithmic pricing, and collusion*** [@Brown2023]\
...
However, after reviewing the replication package for the second paper (@Brown2023)—described in the ***README*** file ([📥Open](README Paper.pdf)), we noticed that, despite its complexity, it offered some compelling advantages.
:::
## 
::: {.smaller}
...
## 
::: {.smaller}
Original from ***The Effect of Gender on Credit Access*** (@Brown2023):\
